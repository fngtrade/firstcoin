...
# TestNode: A peer we use to send messages to firstcoind, and store responses.
...
class CompactBlocksTest(FirstCoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes firstcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that firstcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self):
        ...
        # Note that it's possible for firstcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self):
        ...
        # firstcoind won't respond for blocks whose height is more than 15 blocks
        # deep.
