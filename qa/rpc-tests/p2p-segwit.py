#!/usr/bin/env python3
# Copyright (c) 2016 The Bitcоin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

from test_framework.mininode import *
from test_framework.test_framework import FirstCoinTestFramework
...
class SegWitTest(FirstCoinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--oldbinary", dest="oldbinary",
                          default=None,
                          help="pre-segwit firstcoind binary for upgrade testing")
    ...
    def setup_network(self):
        ...
        # If an old firstcoind is given, do the upgrade-after-activation test.
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, firstcoind delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let firstcoind fill it in.
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older firstcoind's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-firstcoind> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active firstcoind
