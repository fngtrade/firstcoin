...
###   This script attempts to download the signature file SHA256SUMS.asc from firstcoin.org
...
WORKINGDIR="/tmp/firstcoin_verify_binaries"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test"
BASEDIR="https://firstcoin.org/bin/"
VERSIONPREFIX="firstcoin-core-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'firstcoin-',
