...
unlocked to sign the FirstCoin-Qt.app bundle.
...
allowing somebody to distribute a FirstCoin-Qt.app or firstcoin-qt-setup.exe with a valid
...
that the firstcoin-qt.exe file inside the installer had not been tampered with.
