...
static bool AppInitRawTx(int argc, char* argv[]) {
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help")) {
        ...
        std::string strUsage = strprintf(_("%s firstcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                "  firstcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded firstcoin transaction") + "\n" +
                "  firstcoin-tx [options] -create [commands]   " + _("Create hex-encoded firstcoin transaction") + "\n" +
                "\n";
...
static int CommandLineRawTx(int argc, char* argv[]) {
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded firstcoin transaction
