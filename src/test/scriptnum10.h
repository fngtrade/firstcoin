...
#ifndef FIRSTCOIN_TEST_SCRIPTNUM10_H
#define FIRSTCOIN_TEST_SCRIPTNUM10_H
...
class CScriptNum10 {
    /**
     * The ScriptNum implementation from FirstCoin Core 0.10.0, for cross-comparison.
     */
public:
