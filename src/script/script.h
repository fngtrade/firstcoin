...
#ifndef FIRSTCOIN_SCRIPT_SCRIPT_H
#define FIRSTCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, FirstCoin always counted CHECKMULTISIGs
...
#endif // FIRSTCOIN_SCRIPT_SCRIPT_H
