...
#ifndef FIRSTCOIN_QT_FIRSTCOINUNITS_H
#define FIRSTCOIN_QT_FIRSTCOINUNITS_H
 ...
 */
class FirstCoinUnits : public QAbstractListModel {
    Q_OBJECT

public:
    explicit FirstCoinUnits(QObject *parent);
...
typedef FirstCoinUnits::Unit BitcoinUnit;

#endif // FIRSTCOIN_QT_FIRSTCOINUNITS_H
