 ...
 */
#ifndef FIRSTCOIN_UTIL_H
#define FIRSTCOIN_UTIL_H
...
extern const char * const FIRSTCOIN_CONF_FILENAME;
extern const char * const FIRSTCOIN_PID_FILENAME;
...
template <typename Callable> void TraceThread(const char* name, Callable func) {
    std::string s = strprintf("firstcoin-%s", name);
